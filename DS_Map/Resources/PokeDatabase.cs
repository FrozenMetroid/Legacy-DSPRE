        ...
        public static class System {
            ...
            public static class MatrixCellColors {
                ...
                public static Dictionary<List<uint>, (Color back, Color fore)> HGSSmatrixColorsDict = new Dictionary<List<uint>, (Color back, Color fore)> {
                    ...
                    [new List<uint> { 681 }] = (Color.SteelBlue, Color.White),
                    [new List<uint> { 682 }] = (Color.SteelBlue, Color.White),
                    [new List<uint> { 687 }] = (Color.ForestGreen, Color.White),
                    [new List<uint> { 691 }] = (Color.ForestGreen, Color.White),
                    [new List<uint> { 693 }] = (Color.ForestGreen, Color.White),
                    [new List<uint> { 694 }] = (Color.ForestGreen, Color.White),
                    [new List<uint> { 695 }] = (Color.ForestGreen, Color.White),
                    [new List<uint> { 697 }] = (Color.ForestGreen, Color.White),
                    [new List<uint> { 698 }] = (Color.ForestGreen, Color.White),
                    [new List<uint> { 699 }] = (Color.ForestGreen, Color.White),
                    [new List<uint> { 702 }] = (Color.ForestGreen, Color.White),
                    [new List<uint> { 703 }] = (Color.ForestGreen, Color.White),
                    [new List<uint> { 704 }] = (Color.ForestGreen, Color.White),
                    [new List<uint> { 705 }] = (Color.ForestGreen, Color.White),
                    [new List<uint> { 706 }] = (Color.ForestGreen, Color.White),
                    ...
                    [new List<uint> { 830 }] = (Color.ForestGreen, Color.White),
                    [new List<uint> { 831 }] = (Color.ForestGreen, Color.White),
                    [new List<uint> { 832 }] = (Color.SteelBlue, Color.White),
                    ...
                    [new List<uint> { 849 }] = (Color.ForestGreen, Color.White),
